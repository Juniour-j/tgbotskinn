...
Короткий `csgo.json` для цін не використовується — на кейсах він занижений на
кілька центів проти сайту.
...
Навіть точна мінімальна ціна часто — це 1-2 лоти. Приклад
(*Sealed Dead Hand Terminal*): мін $0.39 — це **2 шт**, а реальний ринок
